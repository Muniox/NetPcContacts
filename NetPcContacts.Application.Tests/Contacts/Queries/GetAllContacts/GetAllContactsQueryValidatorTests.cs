...
namespace NetPcContacts.Application.Tests.Contacts.Queries.GetAllContacts
{
    ...
    /// Sprawdzaj� poprawno�� walidacji parametr�w paginacji, wyszukiwania i sortowania.
    /// </summary>
    public class GetAllContactsQueryValidatorTests
    {
        ...
        {
            // Arrange - SearchPhrase nie ma ogranicze�
            var query = CreateValidQuery();
        ...
        /// <summary>
        /// Tworzy poprawne zapytanie GetAllContactsQuery do test�w.
        /// </summary>
