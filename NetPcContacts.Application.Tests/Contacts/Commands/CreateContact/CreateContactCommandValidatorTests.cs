...
namespace NetPcContacts.Application.Tests.Contacts.Commands.CreateContact
{
    ...
    /// Sprawdzają poprawność walidacji danych wejściowych zgodnie z regułami biznesowymi.
    /// </summary>
    public class CreateContactCommandValidatorTests
    {
        ...
        public void Validate_ForEmptyName_ReturnsFailure()
        {
            ...
            result.Errors.Should().Contain(e => e.PropertyName == "Name" && e.ErrorMessage == "Imię jest wymagane.");
        }
        ...
        public void Validate_ForNameTooLong_ReturnsFailure()
        {
            ...
            // Assert
            result.IsValid.Should().BeFalse();
            result.Errors.Should().Contain(e => e.PropertyName == "Name" && e.ErrorMessage == "Imię musi zawierać od 1 do 100 znaków.");
        }
        ...
        public void Validate_ForSurnameTooLong_ReturnsFailure()
        {
            ...
            // Assert
            result.IsValid.Should().BeFalse();
            result.Errors.Should().Contain(e => e.PropertyName == "Surname" && e.ErrorMessage == "Nazwisko musi zawierać od 1 do 100 znaków.");
        }
        ...
        public void Validate_ForInvalidEmailFormat_ReturnsFailure()
        {
            ...
            // Assert
            result.IsValid.Should().BeFalse();
            result.Errors.Should().Contain(e => e.PropertyName == "Email" && e.ErrorMessage == "Nieprawidłowy format adresu email.");
        }
        ...
        public void Validate_ForEmailTooLong_ReturnsFailure()
        {
            ...
            // Assert
            result.IsValid.Should().BeFalse();
            result.Errors.Should().Contain(e => e.PropertyName == "Email" && e.ErrorMessage == "Email nie może przekraczać 255 znaków.");
        }
        ...
        public void Validate_ForEmptyPassword_ReturnsFailure()
        {
            ...
            // Assert
            result.IsValid.Should().BeFalse();
            result.Errors.Should().Contain(e => e.PropertyName == "Password" && e.ErrorMessage == "Hasło jest wymagane.");
        }
        ...
        public void Validate_ForPasswordTooShort_ReturnsFailure()
        {
            ...
            // Assert
            result.IsValid.Should().BeFalse();
            result.Errors.Should().Contain(e => e.PropertyName == "Password" && e.ErrorMessage == "Hasło musi zawierać minimum 8 znaków.");
        }
        ...
        public void Validate_ForPasswordTooLong_ReturnsFailure()
        {
            ...
            // Assert
            result.IsValid.Should().BeFalse();
            result.Errors.Should().Contain(e => e.PropertyName == "Password" && e.ErrorMessage == "Hasło nie może przekraczać 100 znaków.");
        }
        ...
        public void Validate_ForPasswordWithoutUpperCase_ReturnsFailure()
        {
            ...
            // Assert
            result.IsValid.Should().BeFalse();
            result.Errors.Should().Contain(e => e.PropertyName == "Password" && e.ErrorMessage == "Hasło musi zawierać przynajmniej jedną wielką literę.");
        }
        ...
        public void Validate_ForPasswordWithoutLowerCase_ReturnsFailure()
        {
            ...
            // Assert
            result.IsValid.Should().BeFalse();
            result.Errors.Should().Contain(e => e.PropertyName == "Password" && e.ErrorMessage == "Hasło musi zawierać przynajmniej jedną małą literę.");
        }
        ...
        public void Validate_ForPasswordWithoutDigit_ReturnsFailure()
        {
            ...
            // Assert
            result.IsValid.Should().BeFalse();
            result.Errors.Should().Contain(e => e.PropertyName == "Password" && e.ErrorMessage == "Hasło musi zawierać przynajmniej jedną cyfrę.");
        }
        ...
        public void Validate_ForPasswordWithoutSpecialChar_ReturnsFailure()
        {
            ...
            // Assert
            result.IsValid.Should().BeFalse();
            result.Errors.Should().Contain(e => e.PropertyName == "Password" && e.ErrorMessage == "Hasło musi zawierać przynajmniej jeden znak specjalny.");
        }
        ...
        public void Validate_ForPhoneNumberWithInvalidCharacters_ReturnsFailure()
        {
            ...
            // Assert
            result.IsValid.Should().BeFalse();
            result.Errors.Should().Contain(e => e.PropertyName == "PhoneNumber" && e.ErrorMessage == "Numer telefonu może zawierać tylko cyfry, spacje, myślniki, plus i nawiasy.");
        }
        ...
        public void Validate_ForPhoneNumberTooShort_ReturnsFailure()
        {
            ...
            // Assert
            result.IsValid.Should().BeFalse();
            result.Errors.Should().Contain(e => e.PropertyName == "PhoneNumber" && e.ErrorMessage == "Numer telefonu musi zawierać od 9 do 20 znaków.");
        }
        ...
        public void Validate_ForFutureBirthDate_ReturnsFailure()
        {
            ...
            // Assert
            result.IsValid.Should().BeFalse();
            result.Errors.Should().Contain(e => e.PropertyName == "BirthDate" && e.ErrorMessage == "Data urodzenia musi być datą z przeszłości.");
        }
        ...
        public void Validate_ForBirthDateTooOld_ReturnsFailure()
        {
            ...
            // Assert
            result.IsValid.Should().BeFalse();
            result.Errors.Should().Contain(e => e.PropertyName == "BirthDate" && e.ErrorMessage == "Data urodzenia nie może być starsza niż 150 lat.");
        }
        ...
        public void Validate_ForInvalidSubcategoryId_ReturnsFailure()
        {
            ...
            // Assert
            result.IsValid.Should().BeFalse();
            result.Errors.Should().Contain(e => e.PropertyName == "SubcategoryId" && e.ErrorMessage == "Podkategoria musi mieć prawidłową wartość.");
        }
        ...
        public void Validate_ForCustomSubcategoryTooLong_ReturnsFailure()
        {
            ...
            // Assert
            result.IsValid.Should().BeFalse();
            result.Errors.Should().Contain(e => e.PropertyName == "CustomSubcategory" && e.ErrorMessage == "Niestandardowa podkategoria nie może przekraczać 100 znaków.");
        }

        #endregion

        /// <summary>
        /// Tworzy poprawną komendę CreateContactCommand do testów.
        /// </summary>
